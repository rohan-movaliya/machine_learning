...
diabetes_model = pickle.load(open("D:/Python Devlopment/ML Coures/Part 5/5.2. Multiple Disease Prediction System/diabetes_model.sav", "rb"))

heart_disease_model = pickle.load(open("D:/Python Devlopment/ML Coures/Part 5/5.2. Multiple Disease Prediction System/heart_disease_model.sav", "rb"))

parkinsons_model = pickle.load(open("D:/Python Devlopment/ML Coures/Part 5/5.2. Multiple Disease Prediction System/parkinsons_model.sav", "rb"))
